...
if($postjson['requisicao'] == 'listar'){
            ...
            $query = mysqli_query($mysqli, "select * from movimentacoes where data >= '$postjson[dataBuscarInicial]' and data <= '$postjson[dataBuscarFinal]' order by id desc limit $postjson[start], $postjson[limit]");
